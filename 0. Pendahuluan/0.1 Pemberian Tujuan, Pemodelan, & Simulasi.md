...
Secara amnya, model-model operasi cuma berperanan dalam penentuan sifat simulasi atau pemprosesan model pembawa data tertentu; mereka tidak berperanan memegang data atau mengekal status. Secara amnya model-model operasi tidak berstatus, yakni mereka tidak mengekal sebarang butiran yang mengalir melalui mereka melainkan mewakilkan tugasan pengelogan bagi tujuan pemerhatian dan pemantauan.